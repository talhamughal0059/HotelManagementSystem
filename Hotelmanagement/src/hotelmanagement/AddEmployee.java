...
public class AddEmployee extends JFrame implements ActionListener {
    ...
    AddEmployee(){
        ...
        JLabel aadhar = new JLabel("ID-Card");
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("hotelmanagement/icons/employees.png"));
        Image i2 = i1.getImage().getScaledInstance(420, 380, Image.SCALE_DEFAULT);
        ImageIcon i3 = new ImageIcon(i2);
        JLabel l1 = new JLabel(i3);
        l1.setBounds(400, 50, 490, 450);
        add(l1);
        
        JLabel l2 = new JLabel("ADD EMPLOYEE DETAILS");
        l2.setBounds(450,30,400,30);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        conn c = new conn();
        String str = "insert into employee values('"+name+"','"+age+"','"+gender+"','"+job+"','"+salary+"','"+phone+"','"+cardno+"','"+email+"')";
